...
python AGE_64.py --dataset celeba --batch_size 64 --nepoch 5 --drop_lr 5 --c_dim 3 --z_dim 64 --miu 10 --lamb 1000 --g_step 3

python AGE_64.py --dataset celeba --batch_size 256 --nepoch 6 --drop_lr 5 --c_dim 3 --z_dim 64 --miu 15 --lamb 1000 --g_step 3 --restore True