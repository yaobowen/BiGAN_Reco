...
python AGE_32.py --dataset svhn --batch_size 64 --nepoch 20 --drop_lr 10 --c_dim 3 --z_dim 64 --miu 10 --lamb 1000 --g_step 2

python AGE_32.py --dataset svhn --batch_size 256 --nepoch 20 --drop_lr 10 --c_dim 3 --z_dim 64 --miu 15 --lamb 1000 --g_step 2 --restore True